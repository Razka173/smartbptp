<div class="text-center">
    <img src="<?php echo base_url() ?>assets/smartbptp/img/bannersmartbptp.gif" class="img-fluid" alt="...">
</div>

<div style="background-color: rgb(255, 255, 255);">
    <div class="container">
        <br>
        <p class="text-justify"><b>SMART BPTP</b> Jakarta merupakan sistem aplikasi pelayanan publik BPTP Jakarta berbasis online untuk memberikan pelayanan dengan cara cepat, tepat, akurat, serta mudah. Layanan publik ini terdiri dari empat jenis layanan.</p>
